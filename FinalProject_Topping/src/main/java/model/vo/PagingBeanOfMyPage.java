 ...
 *
 */
public class PagingBeanOfMyPage extends PagingBean {
	
	public PagingBeanOfMyPage(int totalContent, int nowPage) {
		super(totalContent, nowPage);
	...
	/**
	 * 한 페이지에서 보여줄 게시물 수		15
	 */
	private int numberOfContentPerPage=CommonConstants.CONTENT_NUMBER_PER_PAGE_MYPAGE;
	/**
	 * 한 페이지 그룹내 페이지 수			5
	 */
	private int numberOfPageGroup=CommonConstants.PAGEGROUP_NUMBER_PER_PAGE_MYPAGE;
	/**
