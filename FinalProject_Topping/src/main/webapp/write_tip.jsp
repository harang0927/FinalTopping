	...
	src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js"></script>
        ...
        <section id="contact-section">
			...
			<section  class="col-sm-10">
				<form action="tip.do" method="post" name="tip_form" enctype="multipart/form-data" onsubmit="checkFlag()">
				<input type="hidden" name="command" value="writeTip">
				<div class="col-sm-4"> 
				<div id="write-header">Writing Tip Form</div><br>
				...
				TITLE<input type="text" name="title" id="title"  maxlength="80" required="required"><br>
				<input type="hidden" id="placeId" name="placeVO.placeId" readonly="readonly" data-toggle="tooltip" data-placement="right" title="Please enter a location in the search box."><br>
				</div>
				
				<div id="mapdiv" class="col-sm-8">
						<input id="pac-input" type="text" placeholder="Search Box" required="required">		
					<div id="map" style="float: none;"></div>	
				</div>
				<div class="col-sm-12" >
				CONTENT<br>
				<textarea rows="10" name="content" id="content" style="resize:none;width:100%; overflow:hidden;" required="required" ></textarea><br>
				</div>
				...
				<div class="col-sm-12">
					...
					<div class="col-sm-4">
						...
						<input type="file" name="uploadFile[3]">
					</div>
					<div class="col-sm-4">
						<input type="file" name="uploadFile[4]">
					</div>
				...
				<div class="col-sm-12">
				<hr>
					<input type="submit" value="SEND" style="float:right;background-color:#333333;border-radius:4px;color:#ffffff;">
